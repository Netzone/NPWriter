    ...
    triggerFetch(resource, info) {
        ...
        resource.fetchPayload(this.context, (err, props) => {
            if (err) {
                ...
                this._updateNode(resource.id, props, info)
            }
        })
    }
...
// happens only once. We may want to adapt other fetching strategies as well.
//
// TODO: Should be deprecated if Substance implement a way to call
// */
//
// class NPWriterResourceManager {
//     constructor(editorSession, context) {
//         this.editorSession = editorSession
//         this.context = context
//         this.editorSession.onRender('document', this._onDocumentChange, this)
...
//         resource.fetchPayload(this.context, (err, props, info) => {
//             if (err) {
//                 this._updateNode(
//                     resource.id,
//                     {
...
//
//
// export default NPWriterResourceManager
